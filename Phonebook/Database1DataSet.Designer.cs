    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Na" +
                "me) AND ((@IsNull_Number = 1 AND [Number] IS NULL) OR ([Number] = @Original_Numb" +
                "er)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [Name] = @Name, [Number] = @Number WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ((@IsNull_Number = 1 AND [Number] IS NULL) OR ([Number] = @Original_Number)));
SELECT Id, Name, Number FROM [Table] WHERE (Id = @Id)";
